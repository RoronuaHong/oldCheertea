...
//	gulp.watch("html/scss/**/*", ["less"]);
//	gulp.watch("html/js/**/*", ["js", "otherjs"]);
//	gulp.watch("html/cn/**/*", ["rev-html"]);
//	gulp.watch("html/index.html", ["rev-html"]);
	...
	// gulp.watch("html/scss/**/*", ["less"]);
	// gulp.watch("html/js/**/*", ["js", "otherjs"]);
	// gulp.watch("html/cn/**/*", ["rev-html"]).on("change", reload);
	// gulp.watch("html/indexs.html", ["rev-html"]).on("change", reload);
    ...
    gulp.watch("html/indexs.html", ["starts"]).on("change", reload);
});

//启动所有任务
gulp.task("starts", ["clean"], function() {
	return gulp.start("images", "demoimages", "rev-html")
});
...
// 		.pipe(gulp.dest("dist/css/"))
// 		.pipe(plugins.rev.manifest())
// 		.pipe(gulp.dest("dist/css/rev-css"))
// 		.pipe(reload({stream: true}));
// });

//压缩图片
gulp.task("images", function() {
	// return gulp.src("html/images/*.{png, jpg, jpeg}")
...
//压缩图片
gulp.task("demoimages", function() {
	// return gulp.src("html/images/demo/*.{png, jpg, jpeg}")
	// 	.pipe(plugins.imagemin({
	// 		use: [jpgmin, pngmin]
	// 	}))
	// 	.pipe(gulp.dest("dist/images/demo"))
	// 	.pipe(reload({stream: true}));
});

//雪碧图
gulp.task("spritesmith", function() {
	// return gulp.src("html/images/personcenter/*.png")
	// 	.pipe(plugins.spritesmith({
	// 		imgName: "personcentersprites.png",
	// 		cssName: "personcentersprites.css",
	// 		padding: 150,
